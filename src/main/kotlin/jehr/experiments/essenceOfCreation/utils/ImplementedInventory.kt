...
/**Source code courtesy of Juuz through https://wiki.fabricmc.net/tutorial:inventory, translated into Kotlin and modified.*/
interface ImplementedInventory : Inventory {
    ...
    //    Throws an error, no idea what its supposed to be anyways
    //    /**
